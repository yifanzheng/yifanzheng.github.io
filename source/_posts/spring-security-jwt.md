...
![correctToken](correctToken.png)  

**带上不正确的 token 访问需要身份验证的资源**

![incorrectToken](incorrectToken.png)
...
[spring-security-jwt](https://github.com/yifanzheng/spring-security-jwt)
